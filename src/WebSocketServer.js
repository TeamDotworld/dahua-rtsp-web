...
var WebsocketServer = function(a, b) {
        ...
        b.ResponseCode === x.UNAUTHORIZED && "" === z)
            ...
            if ("Describe" === E) {
                ...
                for (g = 0; g < D.Sessions.length; g += 1) {
                    ...
                    i.ClockFreq = D.Sessions[g].ClockFreq,
                    i.Port = parseInt(D.Sessions[g].Port),
                    A.push(i)) : console.log("Unknown codec type:", D.Sessions[g].CodecMime, D.Sessions[g].ControlURL)
                }
                return F = 0,
                E = "Setup",
                d("SETUP", F)
            ...
            if ("Setup" === E) {
                ...
                "Playing" === E || console.log("unknown rtsp state:" + E)
    ...
    function g(a, b, c, d, e, f) {
        var g = null
          , h = null
          , i = null;
        return g = md5(a + ":" + d + ":" + b).toLowerCase(),
    ...
    function j(a) {
        ...
        s = b.length; s > 0; )
            if (36 !== b[0]) {
                ...
                -1 !== d.indexOf("OffLine:KmsUnavailable") && C({
                    errorCode: 203
                }),
                u === !0 ? (f = d.lastIndexOf("\r\n"),
                u = !1) : f = d.search("\r\n\r\n");
